      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <AnimatedSection className="lg:col-span-4 lg:sticky lg:top-28">
            <span className="text-secondary text-sm font-semibold tracking-widest uppercase mb-4 block">What We Offer</span>
            ...
            <div className="w-20 h-1.5 bg-gradient-to-r from-secondary to-accent/60 rounded-full mt-6" />
          </AnimatedSection>
          ...
          <StaggerContainer className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-2 gap-5">
            {features.map((f, i) => (
              <StaggerItem key={i}>
                <div className="group relative bg-card/40 backdrop-blur-sm border border-border/30 rounded-2xl p-8 hover:border-secondary/40 transition-all hover:-translate-y-2 duration-300 cursor-pointer h-full overflow-hidden">
                  {/* Hover glow */}
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center justify-between mb-6">
                      <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-secondary/20 to-secondary/5 flex items-center justify-center group-hover:shadow-lg group-hover:shadow-secondary/10 transition-all duration-300">
                        <f.icon className="w-6 h-6 text-secondary transition-colors duration-300" />
                      </div>
                      <span className="text-muted-foreground/20 text-4xl font-black group-hover:text-secondary/15 transition-colors duration-300">{f.num}</span>
                    </div>
                    ...
                    <div className="flex items-center gap-1 text-secondary text-sm font-medium opacity-0 group-hover:opacity-100 translate-y-2 group-hover:translate-y-0 transition-all duration-300">
